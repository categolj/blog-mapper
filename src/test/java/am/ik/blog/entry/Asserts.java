...
public class Asserts {
	...
	static IsContentExcluded assertEntry99999(Entry entry) {
	...
	static IsContentExcluded assertEntry99998(Entry entry) {
		assertThat(entry).isNotNull();
	...
	static IsContentExcluded assertEntry99997(Entry entry) {
		assertThat(entry).isNotNull();
